...
public interface Serializable {
    ...
    /**
     * Serializes current instance of class to buffer
     * @return Serialized buffer
     */
    @SuppressWarnings("unchecked")
    default byte[] serialize() {
        Serializer serializer = new Serializer(this.getAllocatedSize());
        serializer.struct(this, (Class<Serializable>) this.getClass());
